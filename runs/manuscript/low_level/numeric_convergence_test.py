"""
Error convergence test: compare low-resolution solutions against a high-resolution
reference to compute error convergence rates.

Low-level API version: calls vertical_profiles() and steady_state_transport_solver()
directly. For the config-driven version, see ../interface/numeric_convergence_test.py.
"""
...
if __name__ == "__main__":
    ...
    for i, (modes_i, nz_i) in enumerate(zip(modess, nzs)):
        ...
        z, profs = vertical_profiles(nz_i, meas_height, wind, z0=z0)
