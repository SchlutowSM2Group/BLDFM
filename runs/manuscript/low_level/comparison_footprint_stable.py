...
directly. For the config-driven version, see ../interface/comparison_footprint_stable.py.
"""
...
if __name__ == "__main__":
    ...
    plt.savefig("plots/manuscript_low_level_comparison_footprint_stable.png", dpi=300)
