...
For the equivalent low-level API version, see runs/manuscript/low_level/comparison_footprint_unstable.py.
"""
...
if __name__ == "__main__":
    ...
    config = BLDFMConfig(
        domain=DomainConfig(
            ...
            nz=64, modes=(512, 512), halo=400.0,
        ),
        towers=[tower],
