"""
Compare BLDFM and Kormann-Meixner footprint models under neutral conditions.
...
logger = get_logger("comparison_footprint_neutral")


if __name__ == "__main__":
    # --- Parameters (manuscript values) ---
    nxy = (128, 640)
    domain_ext = (50.0, 250.0)
    meas_pt = (25.0, 20.0)
    meas_height = 10.0
    ustar = 0.668
    z0 = 0.5
    ...
    config = BLDFMConfig(
        domain=DomainConfig(
            ...
            nz=64, modes=(512, 512), halo=500.0,
        ),
        towers=[tower],
    ...
    fig.savefig("plots/comparison_footprint_neutral.png", dpi=300)
